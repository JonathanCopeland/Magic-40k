...
struct CardStack: View {
    ...
    var card = universes.data.cards[3]
    
    var body: some View {
        VStack{
            SwipeCarousel(items: cardsStack, id: \.id) { message,size in
                
                CombinedView(card: message)
        ...
        .onAppear {
            ...
            cardsStack.append(universes.data.cards.randomElement() ?? universes.data.cards[1])
            cardsStack.append(universes.data.cards.randomElement() ?? universes.data.cards[1])
            cardsStack.append(universes.data.cards.randomElement() ?? universes.data.cards[1])
            cardsStack.append(universes.data.cards.randomElement() ?? universes.data.cards[1])
            cardsStack.append(universes.data.cards.randomElement() ?? universes.data.cards[1])
